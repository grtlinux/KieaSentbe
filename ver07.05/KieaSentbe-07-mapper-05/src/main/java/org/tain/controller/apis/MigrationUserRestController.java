...
@RestController
@RequestMapping(value = {"/mapper/migrationUser"})
@Slf4j
public class MigrationUserRestController {
	...
	/*
	 * http://localhost:17087/v0.5/mapper/migrationUser/req/s2j
	 */
	...
	public ResponseEntity<?> commitReqStrToJson(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			_ReqMigrationUserData reqData = new _ReqMigrationUserData();
	...
	/*
	 * http://localhost:17087/v0.5/mapper/migrationUser/res/s2j
	 */
	...
	public ResponseEntity<?> commitResStrToJson(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			_ResMigrationUserData resData = new _ResMigrationUserData();
			resData = (_ResMigrationUserData) TransferStrAndJson.getObject(resData);
	...
	/*
	 * http://localhost:17087/v0.5/mapper/migrationUser/req/j2s
	 */
	...
	/*
	 * http://localhost:17087/v0.5/mapper/migrationUser/res/j2s
	 */
	...
	/*
	 * http://localhost:17087/v0.5/mapper/migrationUser/req/cstruct
	 */
	...
	/*
	 * http://localhost:17087/v0.5/mapper/migrationUser/res/cstruct
	 */
