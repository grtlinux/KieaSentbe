...
@RestController
@RequestMapping(value = {"/mapper/createUser"})
@Slf4j
public class CreateUserRestController {
	...
	public ResponseEntity<?> commitResStrToJson(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			_ResCreateUserData resData = new _ResCreateUserData();
			resData = (_ResCreateUserData) TransferStrAndJson.getObject(resData);
	...
	/*
	 * http://localhost:17087/v0.5/mapper/createUser/res/j2s
	 */
	...
	/*
	 * http://localhost:17087/v0.5/mapper/createUser/req/cstruct
	 */
	...
	/*
	 * http://localhost:17087/v0.5/mapper/createUser/res/cstruct
	 */
