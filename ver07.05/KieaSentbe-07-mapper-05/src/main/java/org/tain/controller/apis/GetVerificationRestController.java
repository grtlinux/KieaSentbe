...
import org.tain.object.getVerification.req._ReqGetVerificationData;
import org.tain.object.getVerification.res._ResGetVerificationData;
...
@RestController
@RequestMapping(value = {"/mapper/getVerification"})
@Slf4j
public class GetVerificationRestController {
	...
	/*
	 * http://localhost:17087/v0.5/mapper/getVerification/req/j2s
	 */
	...
	public ResponseEntity<?> commitReqStrToJson(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			_ReqGetVerificationData reqData = new _ReqGetVerificationData();
			reqData = (_ReqGetVerificationData) TransferStrAndJson.getObject(reqData);
	...
	/*
	 * http://localhost:17087/v0.5/mapper/getVerification/req/s2j
	 */
	...
	public ResponseEntity<?> commitResStrToJson(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			_ResGetVerificationData resData = new _ResGetVerificationData();
			resData = (_ResGetVerificationData) TransferStrAndJson.getObject(resData);
	...
	public ResponseEntity<?> commitReqJsonToStr(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			_ReqGetVerificationData reqData = new ObjectMapper().readValue(lnsJson.getReqJsonData(), _ReqGetVerificationData.class);
	...
	/*
	 * http://localhost:17087/v0.5/mapper/getVerification/res/j2s
	 */
	...
	public ResponseEntity<?> commitResJsonToStr(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			_ResGetVerificationData resData = new ObjectMapper().readValue(lnsJson.getResJsonData(), _ResGetVerificationData.class);
	...
	/*
	 * http://localhost:17087/v0.5/mapper/getVerification/req/cstruct
	 */
	...
	public ResponseEntity<?> detailReqCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			String reqCStruct = TransferStrAndJson.getCStruct(new _ReqGetVerificationData());
	...
	/*
	 * http://localhost:17087/v0.5/mapper/getVerification/res/cstruct
	 */
	...
	public ResponseEntity<?> commitResCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			String resCStruct = TransferStrAndJson.getCStruct(new _ResGetVerificationData());
