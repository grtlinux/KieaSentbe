...
import org.tain.object.deleteUser.req._ReqDeleteUserData;
import org.tain.object.deleteUser.res._ResDeleteUserData;
...
@RestController
@RequestMapping(value = {"/mapper/deleteUser"})
@Slf4j
public class DeleteUserRestController {
	...
	/*
	 * http://localhost:17087/v0.5/mapper/deleteUser/req/j2s
	 */
	...
	public ResponseEntity<?> commitReqStrToJson(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			_ReqDeleteUserData reqData = new _ReqDeleteUserData();
			reqData = (_ReqDeleteUserData) TransferStrAndJson.getObject(reqData);
	...
	/*
	 * http://localhost:17087/v0.5/mapper/deleteUser/req/s2j
	 */
	...
	public ResponseEntity<?> commitResStrToJson(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			_ResDeleteUserData resData = new _ResDeleteUserData();
			resData = (_ResDeleteUserData) TransferStrAndJson.getObject(resData);
	...
	public ResponseEntity<?> commitReqJsonToStr(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			_ReqDeleteUserData reqData = new ObjectMapper().readValue(lnsJson.getReqJsonData(), _ReqDeleteUserData.class);
	...
	/*
	 * http://localhost:17087/v0.5/mapper/deleteUser/res/j2s
	 */
	...
	public ResponseEntity<?> commitResJsonToStr(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			_ResDeleteUserData resData = new ObjectMapper().readValue(lnsJson.getResJsonData(), _ResDeleteUserData.class);
	...
	/*
	 * http://localhost:17087/v0.5/mapper/deleteUser/req/cstruct
	 */
	...
	public ResponseEntity<?> detailReqCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			String reqCStruct = TransferStrAndJson.getCStruct(new _ReqDeleteUserData());
	...
	/*
	 * http://localhost:17087/v0.5/mapper/deleteUser/res/cstruct
	 */
	...
	public ResponseEntity<?> commitResCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			String resCStruct = TransferStrAndJson.getCStruct(new _ResDeleteUserData());
