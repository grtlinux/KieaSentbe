...
public class Json04Working {
	...
	public void test01() throws Exception {
		...
		System.out.println("[1] >>>>> " + jsonNodeInfo.toPrettyString());
		traverse(jsonNodeInfo, 1);
		...
		JsonNode inputNode = new ObjectMapper().readTree(jsonInput);
		System.out.println("[2] >>>>> " + inputNode.toPrettyString());
		
		traverse(inputNode, 1);
	}
