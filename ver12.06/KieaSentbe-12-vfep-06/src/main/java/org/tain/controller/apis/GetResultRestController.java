...
@Controller
@RequestMapping(value = {"/apis/getResult"})
@Slf4j
public class GetResultRestController {
	...
	public ResponseEntity<?> mapperReqJson2Str(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("GetResult mapperReqJson2Str");
			lnsJson.setHttpUrl("http://localhost:17087/v0.5/mapper/getResult/req/j2s");
	...
	public ResponseEntity<?> getResult(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			lnsJson.setHttpUrl("http://localhost:17089/v0.5/sbs01/getResult");
			lnsJson.setHttpMethod("POST");
			lnsJson.setType(node.at("/__head_data").get("type").asText());  // TODO
	...
	public ResponseEntity<?> mapperResStr2Json(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("GetResult mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:17087/v0.5/mapper/getResult/res/s2j");
			lnsJson.setHttpMethod("POST");
			lnsJson.setType(node.at("/__head_data").get("type").asText());  // TODO
	...
	public ResponseEntity<?> mapperReqCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("GetResult mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:17087/v0.5/mapper/getResult/req/cstruct");
			lnsJson.setHttpMethod("POST");
	...
	public ResponseEntity<?> mapperResCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("GetResult mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:17087/v0.5/mapper/getResult/res/cstruct");
			lnsJson.setHttpMethod("POST");
			lnsJson.setType(node.get("type").asText());
			lnsJson.setReqJsonData(reqHttpEntity.getBody());
