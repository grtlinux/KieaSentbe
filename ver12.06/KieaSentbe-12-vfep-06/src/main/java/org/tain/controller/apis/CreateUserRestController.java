...
@Controller
@RequestMapping(value = {"/apis/createUser"})
@Slf4j
public class CreateUserRestController {
	...
	public ResponseEntity<?> mapperReqJson2Str(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("CreateUser mapperReqJson2Str");
			lnsJson.setHttpUrl("http://localhost:17087/v0.5/mapper/createUser/req/j2s");
	...
	public ResponseEntity<?> createUser(HttpEntity<String> reqHttpEntity) throws Exception {
		log.info("KANG-20200730 >>>>> {} {}", CurrentInfo.get());
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("CreateUser sbs01");
			lnsJson.setHttpUrl("http://localhost:17089/v0.5/sbs01/createUser");
			lnsJson.setHttpMethod("POST");
			lnsJson.setType(node.at("/__head_data").get("type").asText());  // TODO
	...
	public ResponseEntity<?> mapperResStr2Json(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("CreateUser mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:17087/v0.5/mapper/createUser/res/s2j");
			lnsJson.setHttpMethod("POST");
			lnsJson.setType(node.at("/__head_data").get("type").asText());  // TODO
	...
	public ResponseEntity<?> mapperReqCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("CreateUser mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:17087/v0.5/mapper/createUser/req/cstruct");
			lnsJson.setHttpMethod("POST");
	...
	public ResponseEntity<?> mapperResCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("CreateUser mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:17087/v0.5/mapper/createUser/res/cstruct");
			lnsJson.setHttpMethod("POST");
			lnsJson.setType(node.get("type").asText());
			lnsJson.setReqJsonData(reqHttpEntity.getBody());
