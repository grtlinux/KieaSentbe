...
@Slf4j
public class _CommitRestController {
	...
	public ResponseEntity<?> mapperReqJson2Str(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("Commit mapperReqJson2Str");
			lnsJson.setHttpUrl("http://localhost:18086/v1.0/mapper/commit/req/j2s");
	...
	public ResponseEntity<?> commit(HttpEntity<String> reqHttpEntity) throws Exception {
		log.info("KANG-20200730 >>>>> {} {}", CurrentInfo.get());
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("Commit lns01");
			lnsJson.setHttpUrl("http://localhost:18091/v1.0/lns01/commit");
			lnsJson.setHttpMethod("POST");
	...
	public ResponseEntity<?> mapperResStr2Json(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("Commit mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:18086/v1.0/mapper/commit/res/s2j");
			lnsJson.setHttpMethod("POST");
	...
	public ResponseEntity<?> mapperReqCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("Commit mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:18086/v1.0/mapper/commit/req/cstruct");
			lnsJson.setHttpMethod("POST");
			lnsJson.setReqJsonData(reqHttpEntity.getBody());
	...
	public ResponseEntity<?> mapperResCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("Commit mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:18086/v1.0/mapper/commit/res/cstruct");
			lnsJson.setHttpMethod("POST");
			lnsJson.setReqJsonData(reqHttpEntity.getBody());
