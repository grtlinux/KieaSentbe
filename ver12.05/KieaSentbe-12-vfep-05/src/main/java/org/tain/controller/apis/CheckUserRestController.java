...
public class CheckUserRestController {
	...
	public ResponseEntity<?> mapperReqJson2Str(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			lnsJson.setHttpUrl("http://localhost:17087/v0.5/mapper/checkUser/req/j2s");
	...
	public ResponseEntity<?> checkUser(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			lnsJson.setHttpUrl("http://localhost:17089/v0.5/sbs01/checkUser");
			lnsJson.setHttpMethod("POST");
	...
	public ResponseEntity<?> mapperResStr2Json(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			lnsJson.setHttpUrl("http://localhost:17087/v0.5/mapper/checkUser/res/s2j");
			lnsJson.setHttpMethod("POST");
	...
	public ResponseEntity<?> mapperReqCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("CheckUser mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:17087/v0.5/mapper/checkUser/req/cstruct");
			lnsJson.setHttpMethod("POST");
			lnsJson.setReqJsonData(reqHttpEntity.getBody());
	...
	public ResponseEntity<?> mapperResCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("CheckUser mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:17087/v0.5/mapper/checkUser/res/cstruct");
			lnsJson.setHttpMethod("POST");
			lnsJson.setReqJsonData(reqHttpEntity.getBody());
