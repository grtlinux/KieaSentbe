...
@Controller
@RequestMapping(value = {"/apis/customer"})
@Slf4j
public class _CustomerRestController {
	...
	public ResponseEntity<?> mapperReqJson2Str(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("Customer mapperReqJson2Str");
			lnsJson.setHttpUrl("http://localhost:18086/v1.0/mapper/customer/req/j2s");
	...
	public ResponseEntity<?> customer(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			...
			lnsJson.setHttpUrl("http://localhost:18091/v1.0/lns01/customer");
			lnsJson.setHttpMethod("POST");
	...
	public ResponseEntity<?> mapperResStr2Json(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("Customer mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:18086/v1.0/mapper/customer/res/s2j");
			lnsJson.setHttpMethod("POST");
	...
	public ResponseEntity<?> mapperReqCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("Customer mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:18086/v1.0/mapper/customer/req/cstruct");
			lnsJson.setHttpMethod("POST");
			lnsJson.setReqJsonData(reqHttpEntity.getBody());
	...
	public ResponseEntity<?> mapperResCStruct(HttpEntity<String> reqHttpEntity) throws Exception {
		...
		if (Flag.flag) {
			lnsJson = new LnsJson();
			lnsJson.setName("Customer mapperResStr2Json");
			lnsJson.setHttpUrl("http://localhost:18086/v1.0/mapper/customer/res/cstruct");
			lnsJson.setHttpMethod("POST");
			lnsJson.setReqJsonData(reqHttpEntity.getBody());
